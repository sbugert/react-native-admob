...
const RNBanner = requireNativeComponent('RNAdMobExpress', AdMobExpress);

export default class AdMobExpress extends React.Component {
...
AdMobExpress.defaultProps = { bannerSize: 'smartBannerPortrait', didFailToReceiveAdWithError: () => {} };
